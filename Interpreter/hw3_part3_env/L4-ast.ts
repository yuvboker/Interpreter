...
import {AtomicExp, CExp, makeProcExp, parseL3CExp, ProcExp, VarDecl, VarRef} from './L3-ast';
...
export interface ProcExp4 {tag: "ProcExp4"; args: SharedVarDecl[], body: CExp4[]; };
export interface Binding4 {tag: "Binding4"; var: SharedVarDecl; val: CExp4; };
// L3
...
export const makeProcExp4 = (args: SharedVarDecl[], body: CExp4[]): ProcExp4 =>
...
const parseProcExp4 = (sexps: any[]): ProcExp4 | Error =>
    safeFL((body: CExp4[]) => makeProcExp4( map((decl) => {
        if (decl[1] === 'lazy') {
...
const safeMakeBindings4 = (decls: SharedVarDecl[] | Error, vals: Array<CExp4 | Error>): Binding4[] | Error =>
    isError(decls) ? decls :
